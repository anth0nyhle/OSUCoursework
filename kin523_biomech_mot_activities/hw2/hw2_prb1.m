...
% semicolon operator signifies end of row, col vectors w/ 7 rows, 1 cols
...
% col vectors of X, Y, Z in XYZ matrix will become row vectors of X, Y, Z
...
% inversion of A matrix right multiple by u col vector
L = A \ u; % solve the system of linear equations A*L = u, 11 rows, 1 col

R = (XYZ * L(9:11)) + ones(7, 1);