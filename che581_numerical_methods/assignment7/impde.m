...
%  |   -(r+w)       2+2*r+kdt      -(r-w)          0          0          0          0    ||c(2,j+1)|        | r*c(1,j) + (2-2*r-kdt)*c(2,j) + r*c(3,j)  |    
%  |    0          -(r+w)       2+2*r+kdt     -(r-w)          0          0          0    ||c(3,j+1)|        | r*c(2,j) + (2-2*r-kdt)*c(3,j) + r*c(4,j)  |   
%  |    0           0          -(r+w)      2+2*r+kdt     -(r-w)          0          0    ||c(4,j+1)|   =    | r*c(3,j) + (2-2*r-kdt)*c(4,j) + r*c(5,j)  |
%  |    0           0           0         -(r+w)      2+2*r+kdt     -(r-w)          0    ||c(5,j+1)|        | r*c(4,j) + (2-2*r-kdt)*c(5,j) + r*c(6,j)  |   
%  |    0           0           0          0         -(r+w)      2+2*r+kdt     -(r-w)    ||c(6,j+1)|        | r*c(5,j) + (2-2*r-kdt)*c(6,j) + r*c(7,j)  |  
