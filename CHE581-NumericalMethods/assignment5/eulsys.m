function [tp, yp] = eulsys(dydt, t_span, y0, h, varargin)
% eulsys: Euler for a system of ODEs
% [t, y] = eulsys(dydt, t_span, y_0, h, p1, p2,...): integrates a system
%          of ODEs with Euler's method
% input:
